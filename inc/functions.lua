...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(kgt..":NameBot:")
...
var = 'مطور البوت ' 
elseif redis:sismember(kgt..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(kgt..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء ' 
elseif redis:sismember(kgt..'owners:'..ChatID,UserID) then
var = 'مدير البوت ' 
elseif redis:sismember(kgt..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت ' 
elseif redis:sismember(kgt..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ' 
else
var = 'فقط عضو ' 
end
...
if msg.edited then
redis:incr(kgt..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(kgt..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(kgt..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(kgt..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(kgt..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(kgt..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(kgt..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(kgt..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(kgt..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(kgt..':SUDO_BOT:')
message = '-  قائمه الـمـطـوريـن : \n\n`- مطور اساسي`**\n'..SUDO_USER..' ⇽ ❪' ..SUDO_ID.. '❫\n*———————— *\n'
if #list==0 then  message = message.."* - لا يوجد مطورين حاليا \n⋆*"
else
for k,v in pairs(list) do
local info = redis:hgetall(kgt..'username:'..v)
local count = redis:scard(kgt..'mtwr_count'..v)
...
local monsha = redis:smembers(kgt..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————  \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(kgt..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(kgt..'admins:'..msg.chat_id_)
...
local list = redis:smembers(kgt..'whitelist:'..msg.chat_id_)
...
if redis:sismember(kgt..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kgt..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(kgt..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kgt..'banned:'..msg.chat_id_)
...
if redis:sismember(kgt..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kgt..'gban_users')
...
local list = redis:smembers(kgt..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(kgt..':Filter_Word:'..msg.chat_id_,word) then 
return  "- **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع↯" 
else
redis:sadd(kgt..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(kgt..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(kgt..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(kgt..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(kgt..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(kgt..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(kgt..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..kgt..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(kgt..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(kgt..'group:name'..GroupS) or '')
...
local admins = redis:smembers(kgt..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(kgt..'username:'..value)
if info then 
...
local creators = redis:smembers(kgt..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
...
local creator = redis:smembers(kgt..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(kgt..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(kgt..'group:ids')
message = '- **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(kgt..'group:name'..v)
if info then 
...
redis:del(
kgt..'group:add'..id_group,
kgt..'lock_link'..id_group, 
kgt..'lock_id'..id_group,
kgt..'lock_spam'..id_group, 
kgt..'lock_webpage'..id_group,
kgt..'lock_markdown'..id_group,
kgt..'lock_flood'..id_group,
kgt..'lock_bots'..id_group,
kgt..'mute_forward'..id_group,
kgt..'mute_contact'..id_group,
kgt..'mute_location'..id_group,
kgt..'mute_document'..id_group,
kgt..'mute_keyboard'..id_group,
kgt..'mute_game'..id_group,
kgt..'mute_inline'..id_group,
kgt..'lock_username'..id_group,
kgt..'num_msg_kgt'..id_group,
kgt..'replay'..id_group
)
redis:srem(kgt..'group:ids',id_group)
end
...
redis:hset(kgt..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(kgt..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
function modadd(msg)
if redis:get(kgt..'lock_service') then
service = true
Get_Director = 30
else
service = false
...
if redis:get(kgt..'group:add'..msg.chat_id_) then  return '⋆**المجموعه بالتأكيد تم تفعيلها' end

local UserChaneel = redis:get(kgt..":UserNameChaneel")
...
redis:setex(kgt..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(kgt..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(kgt..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(kgt..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
kgt..'group:add'..msg.chat_id_,true,
kgt..'lock_link'..msg.chat_id_,true, 
kgt..'lock_id'..msg.chat_id_,true,
kgt..'lock_spam'..msg.chat_id_,true,
kgt..'lock_webpage'..msg.chat_id_,true,
kgt..'lock_markdown'..msg.chat_id_,true,
kgt..'lock_flood'..msg.chat_id_,true,
kgt..'lock_bots'..msg.chat_id_,true,
kgt..'mute_forward'..msg.chat_id_,true,
kgt..'mute_contact'..msg.chat_id_,true,
kgt..'mute_location'..msg.chat_id_,true,
kgt..'mute_document'..msg.chat_id_,true,
kgt..'mute_keyboard'..msg.chat_id_,true,
kgt..'mute_game'..msg.chat_id_,true,
kgt..'mute_inline'..msg.chat_id_,true,
kgt..'lock_username'..msg.chat_id_,true,
kgt..'num_msg_kgt'..msg.chat_id_,5, 
kgt..'replay'..msg.chat_id_,true
)

redis:sadd(kgt..'group:ids',msg.chat_id_) 
redis:sadd(kgt..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(kgt..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(kgt..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(kgt..'group:add'..msg.chat_id_) then return '- ** المجموعه بالتأكيد تم تعطيلها' end  
...
if redis:sismember(kgt..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء  \n↯',17,USERCAR) 
end
redis:hset(kgt..'username:'..UserID,'username',Resolv)
redis:sadd(kgt..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء في البوت \n↯',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(kgt..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء \n↯',17,USERCAR) 
end
redis:srem(kgt..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(kgt..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء اساسي \n↯',17,USERCAR) 
end
redis:hset(kgt..'username:'..UserID,'username',Resolv)
redis:sadd(kgt..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء اساسي في البوت \n↯',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(kgt..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء اساسي\n↯',17,USERCAR) 
end
redis:srem(kgt..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(kgt..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد عضو مميز \n↯',17,USERCAR) 
end
redis:hset(kgt..'username:'..UserID, 'username', Resolv)
redis:sadd(kgt..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح عضو مميز \n↯',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(kgt..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس عضو مميز \n↯',17,USERCAR) 
end
redis:srem(kgt..'whitelist:'..ChatID,UserID)
...
if redis:sismember(kgt..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد مدير \n↯',17,USERCAR) 
end
redis:hset(kgt..'username:'..UserID, 'username', Resolv)
redis:sadd(kgt..'owners:'..ChatID,UserID)
...
if redis:sismember(kgt..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ادمن \n↯',17,USERCAR) 
end
redis:hset(kgt..'username:'..UserID, 'username', Resolv)
redis:sadd(kgt..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح ادمن \n↯',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(kgt..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مدير \n↯',17,USERCAR) 
end
redis:srem(kgt..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم تنزيله من المدير  \n↯',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(kgt..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس ادمن \n↯',17,USERCAR) 
end
redis:srem(kgt..'admins:'..ChatID,UserID)
...
return SendMention(ChatID,UserID,MsgID,'𖤂 ~ 𝒏𝒂𝒎𝒆  »'..namei..'\n'
..' 𖤂 ~ 𝑖𝑑 » {'..UserID..'} \n'
..'𖤂 ~ 𝑢𝑠𝑒 » '..useri..'\n'
..'𖤂 ~ 𝑠𝑡𝑎 » '..Getrtba(UserID,ChatID)..'\n'
..'\n ',13,utf8.len(namei))
end

if cmd == "active" then
local maseegs = redis:get(kgt..'msgs:'..UserID..':'..ChatID) or 1
local namei = FlterName(data.first_name_..' '..(data.last_name_ or ""))
return SendMention(ChatID,UserID,MsgID,'𖤂 ~ 𝑢𝑠𝑒 » '..namei..' \n ⋆ 𝑴𝑺𝑮 » ❪ '..maseegs..' ❫ \n⋆ 𝑨𝑪𝑻𝑰𝑽𝑬 »  ❪ '..Get_Ttl(maseegs)..' ❫\n',12,utf8.len(namei)) 
end
...
redis:hset(kgt..'username:'..UserID, 'username', Resolv)
redis:sadd(kgt..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم حظره  \n↯',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(kgt..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتأكيد الغاء حظره  \n↯',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء حظره \n↯',17,USERCAR) 
end
redis:srem(kgt..'banned:'..ChatID,UserID)
...
if redis:sismember(kgt..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتأكيد كتمه  \n↯',17,USERCAR) 
end
redis:hset(kgt..'username:'..UserID, 'username', Resolv)
redis:sadd(kgt..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم كتمه \n↯',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(kgt..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتاكيد الغاء كتمه  \n↯',17,USERCAR) 
end
redis:srem(kgt..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء كتمه  \n↯',17,USERCAR) 
end
...
redis:hset(kgt..'username:'..UserID, 'username',Resolv)
redis:sadd(kgt..'gban_users',UserID)
...
redis:srem(kgt..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء حظره العام \n↯',17,USERCAR) 
end
...
if redis:sismember(kgt..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد مطور \n↯',17,USERCAR) 
end
redis:hset(kgt..'username:'..UserID, 'username', Resolv)
redis:sadd(kgt..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم ترقيته ليصبح مطور \n↯',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(kgt..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مطور \n↯',17,USERCAR) 
end
redis:srem(kgt..':SUDO_BOT:',UserID)
...
redis:hset(kgt..'username:'..UserID, 'username', UserName)
redis:sadd(kgt..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'- **العضو ⇽ ❪ '..UserName..' ❫\n- **الايدي ⇽ ❪ `'..UserID..'` ❫\n- **تمت ترقيته ليصبح منشىء في البوت \n↯')
end
...
return sendMsg(ChatID,MsgID,
  '𖤂 ~ 𝒏𝒂𝒎𝒆  » '..FlterName(data.title_,30)..'\n'
..'𖤂 ~ 𝑖𝑑 » {`'..UserID..'`} \n'
..' 𖤂 ~ 𝑢𝑠𝑒 »  '..UserName..'\n'
..'𖤂 ~ 𝑠𝑡𝑎 » '..Getrtba(UserID,ChatID)..'\n'
..'\n'
...
if redis:sismember(kgt..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'- **العضو ⇽ ❪ '..UserName..' ❫\n- **الايدي ⇽ ❪ `'..UserID..'` ❫\n- **تم بالتأكيد حظره \n↯') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(kgt..'username:'..UserID, 'username', Resolv)
redis:sadd(kgt..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم تقييد آلعضـو بنجآح \n↯',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(kgt..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم فگ تقييد آلعضـو بنجآح \n↯',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(kgt..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(kgt..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'-**العضو ⇽ '..USERNAME..' \n-** الايدي ⇽ (`'..UserID..'`)\n-**انه بالتأكيد ليس مطور \n✓') end
redis:srem(kgt..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n-الايدي ⇽ ❪ '..UserID..' ❫\n-تم تنزيله من المطورين \n↯',17,USERCAR) 
end
...
if redis:get(kgt..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(kgt..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(kgt..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(kgt..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*-* اعدادات المجموعه : \n"
.."\n1-╿التعديل ⇽ "..(redis:get(kgt..'lock_edit'..msg.chat_id_) or 'false')
.."\n2-│الروابط ⇽ "..(redis:get(kgt..'lock_link'..msg.chat_id_) or 'false')
.."\n3-│التاك ⇽ "..(redis:get(kgt..'lock_tag'..msg.chat_id_) or 'false')
.."\n4-│المعرفات ⇽ "..(redis:get(kgt..'lock_username'..msg.chat_id_) or 'false')
.."\n5-│التكرار ⇽ "..(redis:get(kgt..'lock_flood'..msg.chat_id_) or 'false')
.."\n6-│الكلايش ⇽ "..(redis:get(kgt..'lock_spam'..msg.chat_id_) or 'false')
.."\n7-│الويب ⇽ "..(redis:get(kgt..'lock_webpage'..msg.chat_id_) or 'false')
.."\n8-│الماركدوان ⇽ "..(redis:get(kgt..'lock_markdown'..msg.chat_id_) or 'false')
.."\n9-│بالطرد البوتات ⇽ "..(redis:get(kgt..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n10-│البوتات ⇽ "..(redis:get(kgt..'lock_bots'..msg.chat_id_) or 'false')
.."\n11-│عدد التكرار ⇽ "..(redis:get(kgt..'num_msg_kgt'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n-│اعدادات الوسائط :\n"
.."\n*1-│*المتحركه ⇽ "..(redis:get(kgt..'mute_gif'..msg.chat_id_) or 'false')
.."\n2-│الدردشه ⇽ "..(redis:get(kgt..'mute_text'..msg.chat_id_) or 'false')
.."\n3-│الانلاين ⇽ "..(redis:get(kgt..'mute_inline'..msg.chat_id_) or 'false')
.."\n4-│الالعاب ⇽"..(redis:get(kgt..'mute_game'..msg.chat_id_) or 'false')
.."\n5-│الصور ⇽ "..(redis:get(kgt..'mute_photo'..msg.chat_id_) or 'false')
.."\n6-│الفيديو ⇽ "..(redis:get(kgt..'mute_video'..msg.chat_id_) or 'false')
.."\n7-│البصمات ⇽ "..(redis:get(kgt..'mute_audio'..msg.chat_id_) or 'false')
.."\n8-│الصوت ⇽ "..(redis:get(kgt..'mute_voice'..msg.chat_id_) or 'false')
.."\n9-│الملصقات ⇽ "..(redis:get(kgt..'mute_sticker'..msg.chat_id_) or 'false')
.."\n10-│الجهات ⇽ "..(redis:get(kgt..'mute_contact'..msg.chat_id_) or 'false')
.."\n11-│التوجيه ⇽ "..(redis:get(kgt..'mute_forward'..msg.chat_id_) or 'false')
.."\n12-│الموقع ⇽ "..(redis:get(kgt..'mute_location'..msg.chat_id_) or 'false')
.."\n13-│الملفات ⇽ "..(redis:get(kgt..'mute_document'..msg.chat_id_) or 'false')
.."\n14-│الاشعارات ⇽ "..(redis:get(kgt..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n15-│الكيبورد ⇽ "..(redis:get(kgt..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*-│*اعدادات اخرى : "
.."\n\n*1-│*الترحيب ⇽ "..welcomex
.."\n*2-│*الردود ⇽ "..replayx
...
list_settings = "-`اعدادات المجموعه :` "
.."\n\n-1╿التاك ⇽ "..(redis:get(kgt..'lock_tag'..msg.chat_id_) or 'false')
.."\n-2|المعرفات ⇽ "..(redis:get(kgt..'lock_username'..msg.chat_id_) or 'false')
.."\n-3|التعديل ⇽ "..(redis:get(kgt..'lock_edit'..msg.chat_id_) or 'false')
.."\n-4|الروابط ⇽ "..(redis:get(kgt..'lock_link'..msg.chat_id_) or 'false')
.."\n-5|التكرار ⇽ "..(redis:get(kgt..'lock_flood'..msg.chat_id_) or 'false')
.."\n-6|الكلايش ⇽ "..(redis:get(kgt..'lock_spam'..msg.chat_id_) or 'false')
.."\n-7|الويب ⇽ "..(redis:get(kgt..'lock_webpage'..msg.chat_id_) or 'false')
.."\n-8|الماركدوان ⇽ "..(redis:get(kgt..'lock_markdown'..msg.chat_id_) or 'false')
.."\n-9|البوتات بالطرد ⇽ "..(redis:get(kgt..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n-10|البوتات ⇽ "..(redis:get(kgt..'lock_bots'..msg.chat_id_) or 'false')
.."\n-11|عدد التكرار ⇽ "..(redis:get(kgt..'num_msg_kgt'..msg.chat_id_) or 'false')
.."\n—————————\n*-*اعدادات التقـييد :\n"
.."\n*-1|*التقييد بالتوجيه ⇽ "..(redis:get(kgt..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*-2|*التقييد بالصور ⇽ "..(redis:get(kgt..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*-3|*التقييد بالروابط ⇽ "..(redis:get(kgt..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*-4|*التقييد بالمتحركه ⇽ "..(redis:get(kgt..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*-5|*التقييد الفيديو ⇽ "..(redis:get(kgt..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
